...
class Contract:
    ...
    * Deploy a new smart contract using :py:meth:`Contract.constructor.transact()`
    ...
    #
    @combomethod
    def encodeABI(cls, fn_name: str, args: Optional[Any] = None, kwargs: Optional[Any] = None, data: Optional[HexStr] = None) -> HexStr:
        """
    ...
    def _find_matching_fn_abi(
        cls, fn_identifier: Optional[str] = None, args: Optional[Any] = None, kwargs: Optional[Any] = None
    ) -> ABIFunction:
    ...
    @combomethod
    def _encode_constructor_data(cls, args: Optional[Any] = None, kwargs: Optional[Any] = None) -> HexStr:
...
class ContractConstructor:
    ...
    @combomethod
    def estimateGas(
        self, transaction: Optional[TxParams] = None, block_identifier: Optional[BlockIdentifier] = None
    ) -> int:
...
class ConciseMethod:
    ...
    def __init__(
        self, function: 'ContractFunction', normalizers: Optional[Tuple[Callable[..., Any], ...]] = None
    ) -> None:
